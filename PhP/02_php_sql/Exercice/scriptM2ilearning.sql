...
INSERT INTO tag (title) VALUE ('frontend'), ('backend'), ('infra'), ('javascript'), ('php');

INSERT INTO module_tag (module_id, tag_id, created_at) VALUE
    ('1', '2', '2024-03-28'),
    ('1', '5', '2024-03-28'),
    ('2', '1', '2024-03-28'),
    ('3', '2', '2024-03-28'),
...
DROP DATABASE exercice03m2ilearning;